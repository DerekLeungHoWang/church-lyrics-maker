...
const headCells = [
  {
    ...
    label: <FormattedMessage id="lyricsTable.column.title" />,
  },
  {
    id: "composer",
    numeric: true,
    disablePadding: false,
    label: <FormattedMessage id="lyricsTable.column.composer" />,
  },
  {
    id: "lyricist",
    numeric: true,
    disablePadding: false,
    label: <FormattedMessage id="lyricsTable.column.lyricist" />,
  },
  {
    id: "createdAt",
    numeric: true,
    disablePadding: false,
    label: <FormattedMessage id="lyricsTable.column.createdAt" />,
  },
  //   { id: 'lastModifiedAt', numeric: true, disablePadding: false, label: 'Last Modified At' },
  {
    ...
    numeric: true,
    disablePadding: false,
    label: <FormattedMessage id="lyricsTable.column.actions" />,
  },
];
        ...
        <Grid container spacing={1} alignItems="flex-end">
          ...
          <Grid item>
            <TextField
              ...
              label={<FormattedMessage id="lyricsTable.search" />}
            />
          </Grid>
        </Grid>
      </div>
          ...
          <TableContainer ref={tableDataRef}>
            ...
            >
              ...
              <TableBody>
                {data.map((row, index) => {
                  return (
                    <TableRow key={index} ref={tableDataRef}>
                      ...
                      <TableCell align="left" style={{whiteSpace:"nowrap"}}>
                          ...
                          <IconButton
                            name={row._id}
                            onClick={(e) =>
                              handleAddToPlayList(e.currentTarget.name)
                            }
                            aria-label="add"
                          >
                            <AddIcon />
                          ...
                          <IconButton
                            aria-label="edit"
                            name={row._id}
                            onClick={handleFindOneFromTable}
                          >
                            <EditIcon />
                          </IconButton>
                          <IconButton
